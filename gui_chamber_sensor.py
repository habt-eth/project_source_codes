...
dbname='/var/www/temp_chamber.db'
#dbname='/chamber_project/chamber_files/DB_chamber_temp.db'
...
#        curs.execute("SELECT * FROM temps WHERE timestamp>datetime('2015-06-12 13:20:02','-%s hours') AND timestamp<=datetime('2015-06-12 13:20:02')" % interval)
...
#    curs.execute("SELECT timestamp,max(temp) FROM temps WHERE timestamp>datetime('2015-06-12 13:20:02','-%s hour') AND timestamp<=datetime('2015-06-12 13:20:02')" % option)
...
#    curs.execute("SELECT timestamp,min(temp) FROM temps WHERE timestamp>datetime('2015-06-12 13:20:02','-%s hour') AND timestamp<=datetime('2015-06-12 13:20:02')" % option)
...
#    curs.execute("SELECT avg(temp) FROM temps WHERE timestamp>datetime('2015-06-12 13:20:02','-%s hour') AND timestamp<=datetime('2015-06-12 13:20:02')" % option)
...
#    rows=curs.execute("SELECT * FROM temps WHERE timestamp>datetime('2015-06-12 13:20:02','-1 hour') AND timestamp<=datetime('2015-06-12 13:20:02')")
    for row in rows:
...
def print_time_selector(option):
    ...
    print """<form action="/cgi-bin/webgui_chamber.py" method="POST">
